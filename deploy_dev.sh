...
screen -dmS django
# 在django screen中运行命令
screen -S django -p 0 -X stuff "export DJANGO_ENV=dev && /root/anaconda3/envs/py38/bin/python mocks/mock_data.py && nohup  /root/anaconda3/envs/py38/bin/python manage.py runserver 0.0.0.0:4000 &";
